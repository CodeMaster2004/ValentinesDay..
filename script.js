...
const CONTRASENA = "2222"; // Cambia esto por la contraseña que desees
...
function actualizarContador() {
    const fechaInicio = new Date('2022-10-22'); // Cambia esta fecha por la que desees
